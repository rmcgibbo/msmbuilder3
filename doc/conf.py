...
project = u'MSMBuilder3'
copyright = u'2013, Stanford Univeristy and the authors'
...
htmlhelp_basename = 'MSMBuilder3doc'
...
latex_documents = [
  ('index', 'MSMBuilder3.tex', u'MSMBuilder3 Documentation',
...
man_pages = [
    ('index', 'msmbuilder3', u'MSMBuilder3 Documentation',
     [u'Robert McGibbon'], 1)
]
...
texinfo_documents = [
  ('index', 'MSMBuilder3', u'MSMBuilder3 Documentation',
   u'Robert McGibbon', 'MSMBuilder3', 'One line description of project.',
   'Miscellaneous'),
]
